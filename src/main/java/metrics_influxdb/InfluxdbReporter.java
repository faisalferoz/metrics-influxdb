...
public class InfluxdbReporter extends ScheduledReporter {
    ...
    public static class Builder {
        ...
        private boolean reportDeltaCounters;
        ...
        /**
         * Reports delta counter values.
         *
         * @param reportDeltaCounters
         * @return {@code this}
         */
        public Builder reportDeltaCounters(boolean reportDeltaCounters) {
            this.reportDeltaCounters = reportDeltaCounters;
            return this;
        }
    ...
    private final boolean reportDeltaCounters;
    ...
    private InfluxdbReporter(MetricRegistry registry,
        ...
        this.reportDeltaCounters = resetCounters;
    }
    ...
    private void reportTimer(String name, Timer timer, long timestamp) {
        ...
        cachePreviousValues(name, timer);
    ...
    private void reportHistogram(String name, Histogram histogram, long timestamp) {
        ...
        cachePreviousValues(name, histogram);
    ...
    private void reportCounter(String name, Counter counter, long timestamp) {
        ...
        p[0] = timestamp;
        p[1] = reportDeltaCounters ? calculateDelta(name, counter) : counter.getCount();
        assert (p.length == COLUMNS_COUNT.length);
        cachePreviousValues(name, counter);
    ...
    private void reportMeter(String name, Metered meter, long timestamp) {
        ...
        cachePreviousValues(name, meter);
    ...
    private boolean canSkipMetric(String name, Counting counting) {
        // short circuiting
        return skipIdleMetrics && calculateDelta(name, counting) == 0L;
    }
     ...
     * @param counting
     */
    private void cachePreviousValues(String name, Counting counting) {
     ...
     */
    private long calculateDelta(String name, Counting counting) {
